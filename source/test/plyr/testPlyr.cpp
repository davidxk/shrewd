...
int main()
{
	...
	msg= "hold/ \nDIAMONDS 4 \nSPADES K \n/hold \n";
	psr.readHold(msg);
	for(int i=0; i<player.hole.size(); i++)
		cout<<player.hole[i].print()<<"\t";
	cout<<endl;
	...
	msg= "flop/ \nHEARTS 6 \nDIAMONDS 3 \nCLUBS 10 \n/flop \n";
	psr.readFlop(msg);
	for(int i=0; i<player.comm.size(); i++)
		cout<<player.comm[i].print()<<endl;
