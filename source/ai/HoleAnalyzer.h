...
//12 HandCtgr: { MONSTERS, BIG_PAIRS, .. }
class HoleAnalyzer
{
public:
	enum HandType { TOP_PAIR, SPECULATIVE, POWERHOUSE, NOT_TYPICAL };
	enum HandCtgr { MONSTERS, BIG_PAIRS, MID_PAIRS, SMA_PAIRS, BIG_SU_BRDWY, 
...
public:
	...
	HandCtgr getHandCtgr(vector<Card> hole);
