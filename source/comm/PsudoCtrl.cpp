		...
		char* si, char* sp, char* ci, char* cp)
{
	switch(ch)
	{
		...
		case 1: player=new TestablePlayer(); break;
	}
...
void Controller::start()
{
	...
	while(msg[0]!='g')
	{
		...
		TestablePlayer* testable=(TestablePlayer*) player;
		cout<<testable->reportGameInfo();
		cout<<testable->reportUpdate();
		cout<<testable->reportResult();
	}
